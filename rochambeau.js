var Rochambeau = {
    ...
    updateMatchScore: function () {
        if (Rochambeau.localscore.wins == 2) {
            ...
            Rochambeau.localscore.wins = 0;
            Rochambeau.localscore.losses = 0;
            Rochambeau.localscore.ties = 0;
